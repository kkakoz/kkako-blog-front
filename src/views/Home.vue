  ...
  <div class="home">
    <el-row type="flex" justify="space-between">
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
        <div class="articles">
          <div v-for="(item, index) in articles" v-bind:key="item.id" 
          :class="index%2!=0?'article row-recover':'article row'"
          >
            <div class="leftbox">

              <img src="../assets/avatar.webp" height="100%">
            </div>
            ...
            <div class="rightbox">
              ...
              <div class="type"><i class="el-icon-folder"></i>&nbsp;我的分类</div>
              <div class="content">
                {{item.content}}
              </div>
            </div>
      ...
      <el-col class="hidden-sm-and-down" :md="7" :lg="7" :xl="7">
        <div class="side">
          ...
          <el-row class="links" type="flex" justify="space-between">
            <el-col :span="4">
    ...
    <!-- :class="$store.state.width>900?'home':''"> -->
...
.userinfo {
  height: 150px;
  border-radius: 10px;
  background: url("https://cdn.kaiming66.com/http-8c4ea3c0a1a65d1118594854ca5b9b1b4dcfeed7.jpg") center center;
}
